insert into user values(101, 'London', 'jsingh@abc.com', 'Jobanjit', 'Singh', 'admin', 'ssn101', 'jsingh');
insert into user values(102, 'New Jersey', 'gwiser@abc.com', 'Greg', 'Wiser', 'admin', 'ssn102', 'gwiser');
insert into user values(103, 'New York', 'dmark@abc.com', 'David', 'Mark', 'admin', 'ssn103', 'dmark');    
